...
var (
	...
	F = struct {
		...
		EnableBackendConfigHealthCheckDescription bool
		EnablePinhole                             bool
...
L7 load balancing. CSV values accepted. Example: -node-port-ranges=80,8080,400-500`)
	...
	flag.BoolVar(&F.EnableBackendConfigHealthCheckDescription, "enable-bc-hc-description", false, "Enable update of Health Check Description when BackendConfig present and update of HC after BC removal.")
